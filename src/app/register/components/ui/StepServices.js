    ...
    <div className="w-full min-h-screen flex flex-col items-center">
      ...
      <div className="w-full max-w-2xl mx-auto mt-5 flex-1 space-y-6 ">
        ...
        {services.map((service, index) => (
          <div
            key={index}
            className="flex flex-col md:flex-row gap-4  rounded-xl relative "
          >
            ...
            <div className="w-full md:w-35 flex flex-col items-center">
              <label
                ...
                className="w-36 h-32 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center cursor-pointer hover:border-[#2D464C] text-center"
              >
      ...
      {/* === Navigation Buttons === */}
      <div className="w-full flex max-w-2xl mx-auto mt-8 justify-between pb-5">
        <Button
          variant="outline"
          onClick={prevStep}
        ...
        <Button
          disabled={!allValid}
          onClick={nextStep}
          className={`flex items-center gap-2 px-10 py-3 rounded-xl text-lg font-medium transition-all duration-300 ${
            allValid
